...
export default function CharacterDetail() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)] bg-white text-gray-800">
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto my-12 bg-white rounded-2xl shadow-xl border border-gray-200">
      <Link
        to="/"
        className="text-indigo-600 hover:text-indigo-800 font-semibold flex items-center gap-1 mb-6 transition"
      >
      ...
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-4xl font-extrabold text-center mt-6 text-gray-800">{data.name}</h2>
        <p className="text-center text-gray-600 text-lg font-medium mt-2">{data.status} - {data.species}</p>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            <div className="bg-gray-100 p-5 rounded-lg shadow-sm">
                ...
                <p className="text-lg font-medium text-gray-800 mt-1">{data.origin.name}</p>
            </div>
            <div className="bg-gray-100 p-5 rounded-lg shadow-sm">
                <p className="text-sm font-semibold text-gray-500">Location</p>
                <p className="text-lg font-medium text-gray-800 mt-1">{data.location.name}</p>
            </div>
            <div className="bg-gray-100 p-5 rounded-lg shadow-sm">
                <p className="text-sm font-semibold text-gray-500">Gender</p>
                <p className="text-lg font-medium text-gray-800 mt-1">{data.gender}</p>
            </div>
            <div className="bg-gray-100 p-5 rounded-lg shadow-sm">
                <p className="text-sm font-semibold text-gray-500">Type</p>
                <p className="text-lg font-medium text-gray-800 mt-1">{data.type || "Unknown"}</p>
            </div>
        </div>
